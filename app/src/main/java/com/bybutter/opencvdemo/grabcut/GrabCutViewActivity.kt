...
import kotlinx.android.synthetic.main.activity_grab_cut_view.*
import org.opencv.android.OpenCVLoader
import timber.log.Timber

class GrabCutViewActivity : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grab_cut_view)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.action_mark_fgd -> {
                gv.markForeground()
                true
            }
            R.id.action_mark_bgd -> {
                gv.markBackground()
                true
            }
            R.id.action_mark_roi -> {
                gv.markRoi()
                true
            }
            R.id.action_test -> {
