    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                int pointMoveId = event.getPointerId(event.getActionIndex());
                Timber.e("pointMoveId: %s", pointMoveId);
            ...
            case MotionEvent.ACTION_POINTER_UP:
                ...
                Timber.e("pointerId: %s", pointerId);
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                int pointerId1 = event.getPointerId(event.getActionIndex());
                Timber.e("pointerId1: %s", pointerId1);
                addNewPath(event);
                invalidate();
                break;
